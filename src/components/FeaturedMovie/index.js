        ...
        <div className="featured--vertical">
            <div className="featured--horizontal">
                ...
                <div className="featured--buttons">
                    <a disabled className="featured--watchbutton" href="https://youtube.com/embed/1TmzXqsdAnI?si=KdU2_VBXmPsCuIre?cc_lang_pref=fr&autoplay=1&cc_load_policy=1&controls=0&showinfo=0&autohide=1"><div><PlayArrowIcon />Reproducir</div></a>
